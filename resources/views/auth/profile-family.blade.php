                ...
                <form method="POST" action="{{ route('user.new_person') }}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile" class="form-control numeric mb-0" id="mobileNumber" tabindex="5" placeholder="أدخل رقم الجوال" value="{{ old('mobile') }}"  >
                        </div>
                        <div class="form-group">
                            <label for="email">{{ __('البريد الإلكتروني') }}</label>
                            <input type="email" name="email" class="form-control mb-0" id="email" tabindex="6" placeholder="أدخل البريد الإلكتروني" value="{{ old('email') }}" >
                        </div>
                        <div>
                            <label>النوع</label>
                            <br>
