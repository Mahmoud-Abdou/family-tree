            ...
            <div class="row">
                ...
                <div class="tab-content col-lg-12">
                    <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                        <form dir="rtl" method="POST" action="{{ route('profile.update') }}"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" name="first_name" class="form-control mb-0"
                                                   id="first_name" tabindex="1" value="{{ $person->first_name }}"
                                                   required autofocus>
                                        </div>

                                        <div class="form-group col-lg-4">
                                            <label for="father_name">اسم الأب</label>
                                            <input type="text" name="father_name" class="form-control mb-0"
                                                   id="father_name" tabindex="2" value="{{ $person->father_name }}"
                                                   required>
                                        </div>

                                        <div class="form-group col-lg-4">
                                            <label for="grand_father_name">اسم الجد</label>
                                            <input type="text" name="grand_father_name" class="form-control mb-0"
                                                   id="grand_father_name" tabindex="3"
                                                   value="{{ $person->grand_father_name }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" name="prefix" class="form-control mb-0" id="prefix"
                                                   tabindex="4" value="{{ $person->prefix }}">
                                        </div>

                                        <div class="form-group col-lg-4">
                                            <label for="surname">اللقب</label>
                                            <input type="text" name="surname" class="form-control mb-0" id="surname"
                                                   tabindex="5" value="{{ $person->surname }}">
                                        </div>

                                        <div class="form-group col-lg-4">
                                            <label for="job">العمل / الوظيفة</label>
                                            <input type="text" name="job" class="form-control mb-0" id="job"
                                                   tabindex="6" value="{{ $person->job }}">
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-inline-flex">
                                                    <div class="custom-control custom-radio mx-4">
                                                        <input type="radio" id="male" name="gender" value="male"
                                                               class="custom-control-input" {{ $person->gender == 'male' ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="male"> ذكر </label>
                                                    </div>
                                                    <div class="custom-control custom-radio mx-4">
                                                        <input type="radio" id="female" name="gender" value="female"
                                                               class="custom-control-input" {{ $person->gender == 'female' ? 'checked' : '' }}>
...
{{--                                                <br>--}}
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="image-upload-wrap d-none">
                                                <input id="photo" class="file-upload-input" type="file" name="photo"
                                                       value="{{ old('photo') }}" onchange="readURL(this);"
                                                       accept="image/png,image/jpeg,image/jpg"/>
                                                <div class="drag-text">
                                                    <h3 class="m-4"><i class="ri-upload-2-line"> </i>اضغط أو اسحب صورة
                                                        لرفعها</h3>
                                                </div>
                                            </div>
                                            <div id="photo-content" class="file-upload-content d-block">
                                                <img class="file-upload-image" src="{{ $person->photo }}"
                                                     alt="Person Photo"/>
                                                <div class="image-title-wrap">
                                                    <button type="button" id="remove_photo_btn" class="remove-image">حذف
                                                        <span class="image-title">الصورة المرفوعة</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="birth_place" class="form-control mb-0"
                                                   id="birth_place" value="{{ $person->birth_place }}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="birth_date">تاريخ الميلاد</label>
                                            <input type="date" name="birth_date" class="form-control mb-0"
                                                   id="birth_date"
                                                   value="{{ isset($person->birth_date) ? $person->birth_date : '' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer text-muted">
                                    <div class="row flex inline-flex justify-content-between p-2 mx-2">
                                        <button type="submit" class="btn px-5 btn-primary rounded-pill " tabindex="5"><i
                                                class="ri-save-2-fill"> </i>حفظ
                                        </button>
                        ...
                        <div class="modal fade" id="newFamilyModel" tabindex="-1" role="dialog"
                             aria-labelledby="NewFamilyModelLabel" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="NewFamilyModelLabel">
                                            <i class="ri-user-fill"> </i>ادخال بيانات الزوج/ة </h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" name="partner_first_name" class="form-control mb-0"
                                                   id="partner_first_name" value="{{ old('partner_first_name') }}"
                                                   placeholder="أدخل اﻷسم ">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label for="partner_father_name">{{ __('اسم الأب') }}</label>
                                            <input type="text" name="partner_father_name" class="form-control mb-0"
                                                   id="partner_father_name" value="{{ old('partner_father_name') }}"
                                                   placeholder="أدخل أسم اﻷب ">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label for="partner_grand_father_name">{{ __('أسم الجد') }}</label>
                                            <input type="text" name="partner_grand_father_name" class="form-control mb-0"
                                                   id="partner_grand_father_name" value="{{ old('partner_grand_father_name') }}"
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" data-dismiss="modal" class="btn btn-primary w-100 py-2">
                                            موافق
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="manage-secret" role="tabpanel">
                        ...
                        <div class="card iq-mb-3 shadow">
                            ...
                            <form dir="rtl" class="mt-4" method="POST" action="{{ route('profile.update-user') }}">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="mobile" class="form-control mb-0" id="mobile"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="password" name="password_confirmation"
                                                   class="form-control mb-0" id="password_confirmation">
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer text-muted">
                                    <div class="row flex inline-flex justify-content-between p-2 mx-2">
                                        <button type="submit" class="btn px-5 btn-primary rounded-pill"><i
                                                class="ri-save-2-fill"> </i>حفظ
                                        </button>
