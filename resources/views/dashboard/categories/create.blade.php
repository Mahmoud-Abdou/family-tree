                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" name="name_en" class="form-control mb-0" id="name_en" tabindex="1" placeholder="الاسم (إنجليزي)" value="{{ old('name_en') }}" required autofocus>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="name_ar">الاسم (عربي)</label>
                                        <input type="text" name="name_ar" class="form-control mb-0" id="name_ar" tabindex="2" placeholder="الاسم (عربي)" value="{{ old('name_ar') }}" required>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control" id="type" name="type" tabindex="3">
                                            ...
                                            @foreach($types as $type)
                                                <option value="{{ $type }}" {{ old('type') == $type ? 'selected' : '' }}>{{ \App\Models\Category::getTypeName($type) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div id="icon-content" class="file-upload-content d-none">
                                            <img class="file-upload-image" src="" alt="Category Icon"/>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div id="image-content" class="file-upload-content d-none">
                                            <img class="file-upload-image" src="" alt="Category Image"/>
                                            <div class="image-title-wrap">
                                                <button type="button" class="remove-image">حذف <span class="image-title">الصورة المرفوعة</span></button>
                                            </div>
                                        </div>
