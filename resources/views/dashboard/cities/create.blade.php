                            ...
                            <form dir="rtl" method="POST" action="{{ route('admin.cities.store') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" name="country_en" class="form-control mb-0" id="country_en"
                                               tabindex="1" value="{{ old('country_en') }}" required autofocus>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="country_ar">اسم الدولة (عربي)</label>
                                        <input type="text" name="country_ar" class="form-control mb-0" id="country_ar"
                                               tabindex="2" value="{{ old('country_ar') }}" required>
                                    </div>

                                    <div class="form-group col-lg-6">
                                        <label for="name_en">اسم المدينة (إنجليزي)</label>
                                        <input type="text" name="name_en" class="form-control mb-0" id="name_en"
                                               tabindex="3" value="{{ old('name_en') }}" required>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="name_ar">اسم المدينة (عربي)</label>
                                        <input type="text" name="name_ar" class="form-control mb-0" id="name_ar"
                                               tabindex="4" value="{{ old('name_ar') }}" required>
                                    </div>
