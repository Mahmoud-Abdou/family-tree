...
@section('breadcrumb')
    @include('partials.breadcrumb', ['pageTitle' => '<i class="ri-search-2-line"> </i>'.$menuTitle, 'slots' => [['title' => 'البحث', 'link' => url()->previous()],['title' => $person->full_name, 'link' => url()->previous()],]])
@endsection
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="tab-content">
                        @include('auth.profile-family', ['ownFamily' => $user->profile->OwnFamily, 'family' => $user->profile->belongsToFamily, 'personsData' => []])
