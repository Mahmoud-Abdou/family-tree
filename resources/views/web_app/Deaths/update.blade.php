                        ...
                        <div class="card-body">
                            <form dir="rtl" method="POST" action="{{ route('deaths.update', $death) }}" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="death_date">تاريخ المناسبة</label>
                                        <input type="date" name="death_date" class="form-control mb-0" id="death_date" tabindex="8" value="{{ date('Y-m-d', $death->death_date) }}"  required autofocus>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control mb-0" required autofocus>
                                            ...
                                            @foreach($categories as $category)
                                                @if($category->id == $death->category->id)
