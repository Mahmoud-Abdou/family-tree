                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="event_date" value="{{ old('event_date') }}" class="form-control datetimepicker-input" id="event_date_picker" data-toggle="datetimepicker" data-target="#event_date_picker" required>
                                            </div>
                                        </div>
