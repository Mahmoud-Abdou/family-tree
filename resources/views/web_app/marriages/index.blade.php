...
@section('breadcrumb')
    @include('partials.breadcrumb', ['pageTitle' => '<i class="ri-parent-line"> </i>'.$menuTitle, 'slots' => [['title' => $menuTitle, 'link' => route('marriages.index')],]])
@endsection
            ...
            <div class="row">
                ...
                @if($marriages->count() > 0)
                    @foreach($marriages as $row)
                        <div class="col-sm-4">
                            <a href="{{ route('marriages.show', $row->id) }}">
                ...
                <div class="col-sm-12 my-4 d-flex justify-content-around">{{ $marriages->links() }}</div>
