                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="event_date" value="{{ $event->event_date->format('Y-m-d') }}" class="form-control" id="event_date_picker" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div id="image-content" class="file-upload-content d-block">
                                            <img class="file-upload-image" src="{{ isset($event->image->file) ? $event->image->file : url('default.png') }}" alt="Event Image" />
