...
function readURL(input) {
    ...
    let inputContent = $('#' + input.id + '-content');
    let inputImage = inputContent[0].querySelector('.file-upload-image');
    // let inputTitle = inputContent[0].querySelector('.image-title');
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            inputWrap.classList.remove("d-block");
            inputWrap.classList.add("d-none");
            // inputContent[0].style.display = 'block';
            inputContent[0].classList.remove("d-none");
            inputContent[0].classList.add("d-block");
            // inputTitle.innerHTML = input.files[0].name;
        };
...
// handel remove file upload
$( ".remove-image" ).bind( "click", function() {
    let inputElement = $( this );
    let inputContent = inputElement[0].parentElement.parentElement;
    let inputParent = inputContent.parentElement;
    let inputWrap = inputParent.querySelector('.image-upload-wrap');
    let inputImage = inputContent.querySelector('.file-upload-image');
    // let inputTitle = inputContent.querySelector('.image-title');

    inputImage.src = null;
    // inputContent.style.display = 'none';
    inputContent.classList.remove("d-block");
    inputWrap.classList.add("d-none");
    // inputWrap.style.display = 'block';
    inputWrap.classList.remove("d-none");
    inputWrap.classList.add("d-block");
});
